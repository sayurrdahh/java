...
public class DynamicBeat extends JFrame{
	...
	private ImageIcon backButtonEnteredImage = new ImageIcon(Main.class.getResource("../images/backbuttonent.png"));
	...
	public DynamicBeat() {
		...
		trackList.add(new Track("firstmusic.png", "erf_start_image.jpg", "erf_game_image.jpg", "erf.mp3", "erf.mp3","erf"));
		trackList.add(new Track("secondmusic.png", "groovyhiphop_start_image.jpg", "groovyhiphop_game_image.jpg", "groovyhiphop.mp3", "groovyhiphop.mp3","groovyhiphop"));
		trackList.add(new Track("thirdmusic.png", "highoctane_start_image.jpg", "highoctane_game_image.jpg", "highoctane.mp3", "highoctane.mp3","highocatane"));
	...
	///////////////////
		...
		rightButton.addMouseListener(new MouseAdapter() {
			...
			easyButton.setContentAreaFilled(false); //버튼 테두리 없앰
			...
			easyButton.addMouseListener(new MouseAdapter() {
				...
				hardButton.setContentAreaFilled(false); //버튼 테두리 없앰
				...
				hardButton.addMouseListener(new MouseAdapter() {
					...
					backButton.setContentAreaFilled(false); //버튼 테두리 없앰
